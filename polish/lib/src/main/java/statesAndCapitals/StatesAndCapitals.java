...
public class StatesAndCapitals
{
    ...
    public void testStatesAndCapitals() throws IOException
    {
        ...
        Boolean doAllStatesHaveAnAnthem = states.stream().allMatch(state -> state.getStateAnthem().equals(true));
        ...
        Boolean doNoStatesHaveAOneWordMotto = states.stream().allMatch(state -> state.getStateMotto().equals(false));
